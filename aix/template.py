...
class PromptTemplate:
    ...
    def render(self, variables: Dict[str, str], execute_commands: bool = False, 
               command_executor: Optional[CommandExecutor] = None) -> Tuple[str, Optional[Dict[str, str]]]:
        """
        ...
        if execute_commands and command_executor:
            ...
            result, command_outputs = command_executor.process_template(self.template, variables)
