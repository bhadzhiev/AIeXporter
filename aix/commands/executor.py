...
class ShellCommand(Command):
    ...
    def __init__(self, command_string: str, working_dir: Optional[Path] = None, timeout: int = 30):
...
class CommandExecutor:
    ...
    def create_command(self, command_string: str, intelligent: bool = True) -> Command:
        ...
        if intelligent:
            return IntelligentShellCommand(command_string, self.working_dir, self.timeout)
        return ShellCommand(command_string, self.working_dir, self.timeout)
    
    def execute(self, command_string: str, intelligent: bool = True) -> Tuple[bool, str, str]:
    ...
    def process_template(self, template: str, variables: Dict[str, str]) -> Tuple[str, Dict[str, str]]:
        """
