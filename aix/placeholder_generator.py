...
class PlaceholderExecutor:
    ...
    def execute_generators(self, generators: List[PlaceholderGenerator]) -> Dict[str, str]:
        ...
        for generator in generators:
            try:
                ...
                print(f"Warning: Placeholder generator ({generator.language}) failed: {e}")
                
        return placeholders
    
    def _execute_generator(self, generator: PlaceholderGenerator) -> Optional[Dict[str, str]]:
        ...
        if generator.language.lower() == "python":
            ...
            raise PlaceholderExecutionError(f"Unsupported generator language: {generator.language}")
    ...
    def _execute_python(self, script: str) -> Dict[str, str]:
        ...
        try:
            ...
            if 'placeholders' in local_vars:
                ...
                raise PlaceholderExecutionError("Script must define a 'placeholders' dictionary")
        ...
        try:
            ...
            try:
                ...
                if result.returncode != 0:
                    raise PlaceholderExecutionError(f"Bash script failed: {result.stderr}")
            ...
            raise PlaceholderExecutionError(f"Bash script timed out after {self.timeout} seconds")
        except Exception as e:
