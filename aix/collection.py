        ...
        try:
            ...
            with tempfile.TemporaryDirectory() as temp_dir:
                ...
                if not collections_dir.exists():
                    result["errors"].append(
                        "No 'collections' folder found in repository"
                    )
                    return result
                ...
                if not collection_files:
                    result["errors"].append(
                        "No XML collection files found in collections folder"
                    )
                    return result
                ...
                if collection_name:
                    ...
                    if target_file.exists():
                        ...
                        result["errors"].append(
                            f"Collection '{collection_name}' not found in repository"
                        )
                        return result
                ...
                for collection_file in collection_files:
                    ...
                    if import_result["success"]:
                        ...
                        result["imported_templates"].extend(
                            import_result["imported_templates"]
                        )
                        result["skipped_templates"].extend(
                            import_result["skipped_templates"]
                        )
                    else:
