...
class TestProviderCLI:
    ...
    def test_provider_add_basic(self):
        ...
        result = self.runner.invoke(app, [
            "provider", "add", "test-provider", "http://localhost:8080/v1"
        ])
    ...
    def test_provider_add_with_options(self):
        ...
        result = self.runner.invoke(app, [
            "provider", "add", "full-provider", "http://localhost:11434/v1",
            "--model", "llama3.2",
    ...
    def test_provider_add_invalid_header(self):
        ...
        result = self.runner.invoke(app, [
            "provider", "add", "bad-provider", "http://localhost:8080/v1",
    ...
    def test_provider_info_existing(self):
        ...
        # Add a provider first
        self.runner.invoke(app, [
            "provider", "add", "info-provider", "http://test.com/v1",
            "--model", "info-model",
    ...
    def test_provider_remove_existing(self):
        ...
        # Add a provider first
        self.runner.invoke(app, [
            "provider", "add", "remove-me", "http://remove.com/v1"
        ])
    ...
    def test_provider_workflow(self):
        ...
        # Add provider
        result = self.runner.invoke(app, [
            "provider", "add", "workflow-test", "http://workflow.com/v1",
            "--model", "workflow-model",
            "--header", "X-Workflow:test"
        ])
        assert result.exit_code == 0
    ...
    def test_provider_config_persistence(self):
        ...
        result1 = self.runner.invoke(app, [
            "provider", "add", "persistent", "http://persist.com/v1"
        ])
